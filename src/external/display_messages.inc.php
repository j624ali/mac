...
?>
             ...
             <li class="media media-current-user m-b-md">
                ...
                <a class="media-right" href="#">
                  <img class="img-circle-sm media-object" src="profile_img/<?php echo $user_avatar; ?>">
                </a>
              </li>
...
?>
  ...
  <li class="media m-b-md">
    <a class="media-left" href="#">
      <img class="img-circle-sm media-object" src="profile_img/<?php echo $friend_row['user_avatar']; ?>">
    </a>
    <div class="media-body">
      <div class="media-body-text">
      <?php echo $row['message_content']; ?>
...
$('.media-list-conversation').bind('scroll', function() {
if($(this).scrollTop() + $(this).innerHeight()>=$(this)[0].scrollHeight) {
$('.media-list-conversation').scrollTop($(document).height());
}
});
});
</script>
